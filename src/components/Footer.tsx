...
import { Code2, Camera, Briefcase, Mail, Smartphone } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';

export default function Footer() {
  return (
    <footer className="w-full bg-[#FFE600] text-black mt-20 rounded-t-[3rem] md:rounded-t-[4rem] px-6 md:px-12 pt-16 pb-48 shadow-[0_-20px_50px_rgba(255,230,0,0.2)]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        
        {/* Brand & Project Info */}
        <div className="flex flex-col max-w-md">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center p-1.5 rotate-3 hover:rotate-12 transition-transform shadow-lg bg-black/5">
